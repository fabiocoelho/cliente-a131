...
export const GetSiteBadge = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span id="getsite-badge-text" className="text-[12px] font-normal text-white/75 hover:text-white/90 transition-colors duration-200">Criado por</span>
        <img src={logo} alt="GetSite" loading="lazy" decoding="async" className="h-3 w-[48px] object-contain ml-[8px] mr-[12px] scale-125" />
      </a>
